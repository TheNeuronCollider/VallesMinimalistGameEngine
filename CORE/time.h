...
/* This module calculates the delta time at the end of each frame. Read more
about delta time at the user manual. Also offers a function for getting the
elapsed time since the program excecution.*/
