...
/* This structure acts as collision box or circle. These structures are added
to the game entities in order to make entities detectable by the collision
system */

#ifndef _VMINICOLLIDER_
#define _VMINICOLLIDER_
