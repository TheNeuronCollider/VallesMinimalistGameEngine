...
/* This module offers an easy way for loading files just by giving the file name
and its extension. Automatically finds the file inside the project directories.
*/
