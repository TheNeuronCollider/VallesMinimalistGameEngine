...
/* This module offers:
    1) A function for storing cameras for their management by the engine's core.
    2) A function for deallocating the memory used by the cameras.
    3) A function for updating the cameras.
*/

#ifndef _CAMMANGR_
#define _CAMMANGR_

int storedCAmeras_count;
Camera * arr_cameras[_MAX_CAM_STORAGE_];
